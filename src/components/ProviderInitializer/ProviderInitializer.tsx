    ...
    try {
      ...
      if (fetchedNetworkConfig) {
        ...
        const hasDifferentNetworkConfig =
          network.chainId !== networkConfigResult.drt_chain_id ||
          network.roundDuration !== networkConfigResult.drt_round_duration;

        if (hasDifferentNetworkConfig) {
          updates.chainId = networkConfigResult.drt_chain_id;
          updates.roundDuration = networkConfigResult.drt_round_duration;
        }
      }
